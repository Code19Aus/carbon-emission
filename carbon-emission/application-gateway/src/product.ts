...
const createProduct = async (contract: Contract) => {
    console.log('\n--> Submit Transaction: CreateProduct, creates new product with ID, name, and price arguments');
    await contract.submitTransaction('CreateProduct', uuidv4(), '0014');
    console.log('*** Result: committed');
};

const getAllProduct = async (contract: Contract) => {
